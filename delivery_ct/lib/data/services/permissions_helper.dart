import 'package:delivery_ct/data/services/permissions_service.dart';
...
class PermissionsHelper {
  ...
  ///
  /// Ejemplo de uso en home_user.dart:
  /// ```dart
  /// @override
  /// void initState() {
  ///   super.initState();
  ...
  static Future<void> checkLocationOnAppResume(BuildContext context) async {
    ...
    if (shouldWarn && context.mounted) {
      await _permissionsService.showPermissionWarning(
        ...
        message: 'Activa tu ubicación para ver restaurantes cercanos y calcular tiempos de entrega.',
      );
    }
  }
  ...
  ///
  /// Ejemplo de uso en local_storage.dart:
  /// ```dart
